...
2. Update the version number in **all three** locations:
   - `main.php` — `Version: X.Y.Z` in the plugin header
...
- Detects the version from `main.php`
...
1. Verify the GitHub Release appears at https://github.com/cartpauj/login-or-logout-menu-item/releases
2. Verify the new version appears on https://wordpress.org/plugins/login-or-logout-menu-item/
